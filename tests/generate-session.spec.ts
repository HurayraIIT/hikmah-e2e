...
test("hikmah - authenticated", async ({ browser }) => {
    ...
    await page.getByRole('textbox', { name: 'Something nice to share?' }).fill('## 123 Alhamdulillah'); 
    ...
    await expect(page.getByRole('heading', { name: '123 Alhamdulillah' })).toBeVisible();
